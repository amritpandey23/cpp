...
class Complex
{
    ...
    public:
        ...
        void show_data();
        friend Complex operator+(Complex, Complex);     // operator overloading using friend function
...
Complex operator+(Complex ca, Complex cb)           // operator overloading using friend
{
    Complex temp;
